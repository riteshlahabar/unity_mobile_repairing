            ...
            <ul class="topbar-item list-unstyled d-inline-flex align-items-center mb-0">            
                ...
                <li class="dropdown topbar-item">
                    ...
                    <div class="dropdown-menu dropdown-menu-end py-0">
                        ...
                        <a class="dropdown-item" href="/settings"><i class="las la-user fs-18 me-1 align-text-bottom"></i> Profile</a>                        
                        <small class="text-muted px-2 py-1 d-block">Settings</small>                        
                        <a class="dropdown-item" href="/settings"><i class="las la-cog fs-18 me-1 align-text-bottom"></i> Account Settings</a>
                        <a class="dropdown-item" href="/settings#Security"><i class="las la-lock fs-18 me-1 align-text-bottom"></i> Security</a>
