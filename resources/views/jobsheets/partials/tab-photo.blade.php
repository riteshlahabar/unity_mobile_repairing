...
<div class="tab-pane" id="photo">
    <div class="row">
        <div class="col-md-12">
            <!-- Inside your existing Upload Device Photos section, add this button -->
<div class="mb-3">
    ...
    <input type="file" id="device_camera" name="device_photos[]" accept="image/*" capture="environment" hidden />
    
    <!-- Upload Button -->
    <label class="btn btn-primary me-2" for="device_photos" style="cursor: pointer;">
        <i class="iconoir-upload me-2"></i>Upload Photos
    </label>

    <!-- Take Photo Button -->
    <button type="button" id="takePhotoBtn" class="btn btn-success">
        <i class="iconoir-camera me-2"></i>Take Photo
    </button>
</div>
