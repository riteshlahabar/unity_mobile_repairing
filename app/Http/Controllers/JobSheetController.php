...
class JobSheetController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            $validated = $request->validate([
                ...
                'notes' => 'nullable|string', // Renamed from remarks to notes
            ]);
    ...
    // Show single jobsheet (fetch terms & remarks from general_info for display)
    public function show($id)
    {
        ...
        // Fetch terms & conditions and remarks from general_info table
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            $validated = $request->validate([
                ...
                'notes' => 'nullable|string', // Renamed from remarks
            ]);
    ...
    // Download JobSheet PDF (fetch terms & remarks from general_info for PDF)
    public function downloadPDF($id)
    {
        try {
            ...
            // Generate PDF
            $pdf = Pdf::loadView('pdf.jobsheet', compact('jobSheet', 'generalInfo'));
